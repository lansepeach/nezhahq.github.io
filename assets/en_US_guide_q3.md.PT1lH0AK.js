import{_ as s,c as a,o as i,a4 as n}from"./chunks/framework.BmdFiWrL.js";const y=JSON.parse('{"title":"Dashboard Reverse Proxy Configuration","description":"","frontmatter":{},"headers":[],"relativePath":"en_US/guide/q3.md","filePath":"en_US/guide/q3.md","lastUpdated":1761240202000}'),e={name:"en_US/guide/q3.md"},p=n(`<h1 id="dashboard-reverse-proxy-configuration" tabindex="-1">Dashboard Reverse Proxy Configuration <a class="header-anchor" href="#dashboard-reverse-proxy-configuration" aria-label="Permalink to &quot;Dashboard Reverse Proxy Configuration&quot;">​</a></h1><p>Starting from version V1, Dashboard and gRPC share the default <code>8008</code> port for both access and communication.</p><hr><h2 id="nginx-configuration-example" tabindex="-1">Nginx Configuration Example <a class="header-anchor" href="#nginx-configuration-example" aria-label="Permalink to &quot;Nginx Configuration Example&quot;">​</a></h2><p>Below is an example configuration for setting up a reverse proxy using Nginx:</p><div class="language-nginx vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">nginx</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">server</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
