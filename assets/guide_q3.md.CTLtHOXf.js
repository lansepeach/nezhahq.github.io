import{_ as s,c as a,o as i,a4 as n}from"./chunks/framework.BmdFiWrL.js";const o=JSON.parse('{"title":"Dashboard 反向代理配置","description":"","frontmatter":{},"headers":[],"relativePath":"guide/q3.md","filePath":"guide/q3.md","lastUpdated":1761240202000}'),p={name:"guide/q3.md"},l=n(`<h1 id="dashboard-反向代理配置" tabindex="-1">Dashboard 反向代理配置 <a class="header-anchor" href="#dashboard-反向代理配置" aria-label="Permalink to &quot;Dashboard 反向代理配置&quot;">​</a></h1><p>从 V1 版本开始，不再区分 Dashboard 和 gRPC 端口，访问与通信均通过默认的 <code>8008</code> 端口。</p><hr><h2 id="nginx-配置示例" tabindex="-1">Nginx 配置示例 <a class="header-anchor" href="#nginx-配置示例" aria-label="Permalink to &quot;Nginx 配置示例&quot;">​</a></h2><p>以下是使用 Nginx 配置反向代理的示例：</p><div class="language-nginx vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">nginx</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">server</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
